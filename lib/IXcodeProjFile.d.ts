...
export declare type Section = {
    [uuidOrComment: string]: PBXObjectBase | string;
};
export declare type TypedSection<PBX_OBJECT_TYPE extends PBXObjectBase> = {
    [uuidOrComment: string]: PBX_OBJECT_TYPE | string;
};
/**
 * Once the comments are removed, only PBXObjects remain:
 */
export declare type SectionObjOnly = {
    [uuid: string]: PBXObjectBase;
};
export declare type SectionDictUuidToObj<PBX_OBJECT_TYPE extends PBXObjectBase> = {
    [uuid: string]: PBX_OBJECT_TYPE;
};
export declare type SECTION_DICT = {
    [isaTypeKey: string]: Section;
};
